...
### 🚧 MVP (v0.1.0-dev) — Базовая функциональность готова
- [x] ✅ Регистрация и управление ЖК
- [x] ✅ Привязка пользователей к квартирам  
- [x] ✅ Система заявок по категориям
- [x] ✅ Ролевая модель доступа
- [x] ✅ FSM для управления ЖК (создание/редактирование/удаление)
- [x] ✅ Система "Мои заявки" с архивированием
- [x] ✅ Обработка медиа в заявках с кнопкой "Пропустить"
- [ ] 🔲 Привязка каналов и групп к ЖК
- [ ] 🔲 Привязка УК к ЖК
- [ ] 🔲 Привязка сервисных организаций к ЖК
- [ ] 🔲 Автоматические уведомления при создании заявок

#### 📝 Для завершения MVP остается реализовать:
> **Привязки и уведомления** — ключевые функции для полноценной работы экосистемы ЖКХ. Без них заявки создаются, но не доходят до исполнителей автоматически.
...
**Статус проекта**: 🚧 **В активной разработке** | **Базовая функциональность готова** | **MVP завершается**
