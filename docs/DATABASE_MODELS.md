...
База данных построена на **PostgreSQL** с использованием **SQLAlchemy 2.0** асинхронного ORM. Система состоит из 6 основных таблиц, связанных через внешние ключи и оптимизированных для высокой производительности.
...
*Документация обновлена: 14 июля 2025 г.*  
*Версия схемы БД: 2.1.0*
